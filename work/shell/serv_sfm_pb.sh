...
python3 /root/colmap_detailed/work/python/extract_calib_pb.py ${PROTOBUF_PATH}/photo_record.csv 30 ${PB_LIST_TXT}
...
python3 /root/colmap_detailed/work/python/check_sfm.py ${PROJECT}/sparse/valid/images.txt ${IMAGE}